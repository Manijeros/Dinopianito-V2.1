...
$(document).ready(function(){
  ...
  function Game() {
    ...
    const FILENAMES = [
      // Bitmaps
      '04B_30__.TTF',
      'logo-dinopianito.png',
      'd1.png','d2.png','d3.png','d4.png',
      'c.png','d.png','e.png','f.png','g.png','a.png','b.png',
      'loading.png','back-dino.png',
      // Sounds
      'score.mp3','voz-dinopianito.mp3',
      'kick.mp3','snare.mp3','hhc.mp3',
      'hho.mp3','c.mp3','d.mp3','e.mp3','f.mp3',
      'g.mp3','a.mp3','b.mp3'
    ]
